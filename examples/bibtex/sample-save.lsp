(((type . "Misc")
  (key . "e1-207a-e99")
  (author "Max Rydahl Andersen" "Claus Nyhus Christensen" "Vathanan Kumar" "S{\\o}ren Staun-Pedersen " "Kristian Lykkegaard S{\\o}rensen")
 ...
 ((type . "InBook")
  (key . "Kristensen83")
  (author "B. B. Kristensen" "Ole L. Madsen" "B. M{\\ou}ller-Pedersen" "K. Nygaard")
  (editor "P. Degano" "E. Sandewall")
 ...
 ((type . "InProceedings")
  (key . "Chen95")
  (author "Yih-Farn R. Chen" "Glenn S. Fowler
                 " "Eleftherios Koutsofios" "Ryan S. Wallach")
 ...
 ((type . "InProceedings")
  (key . "Korn99")
  (author "Jeffrey Korn" "Yih-Farn R. Chen
 ...
 ((type . "MastersThesis")
  (key . "e1-207a-f00")
  (author "Max Rydahl Andersen" "Claus Nyhus Christensen" "Kristian
 ...
 ((type . "InProceedings")
  (key . "Normark00a")
  (author "Kurt N{\\o}rmark" "Max Rydahl Andersen" "Claus Nyhus Christensen" "Vathanan Kumar" "S{\\o}ren Staun-Pedersen" "Kristian Lykkegaard S{\\o}rensen")
 ...
 ((type . "Misc")
  (key . "Larsen98")
  (author "Niels C. Larsen" "Martin K. Molz" "Kurt N{\\o}rmark")
