...
(define (rgb-color-encoding . color-pars)
 (cond ((and (= 1 (length color-pars)) (rgb-color? (car color-pars)))
         (let ((the-color (car color-pars)))
           (rgb-string (red-of-rgb-color the-color) (green-of-rgb-color the-color) (blue-of-rgb-color the-color))))

       ((and (= 3 (length color-pars)) (number? (first color-pars)) (number? (second color-pars)) (number? (third color-pars)))
          (rgb-string (first color-pars) (second color-pars) (third color-pars)))

       ((and (= 1 (length color-pars)) (string? (car color-pars)) 
             (= 7 (string-length (car color-pars))) (eq? #\# (string-ref (car color-pars) 0)))
          (car color-pars))
       ...
       ((and (= 1 (length color-pars)) (string? (car color-pars)) 
          ...
          (rgb-color-list (eval (as-symbol (car color-pars)))))

       ((and (= 1 (length color-pars)) (symbol? (car color-pars)))
          (rgb-color-list (eval (car color-pars))))
