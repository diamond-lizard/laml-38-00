...
(define laml-execution-mode 'safe)
...
(define (be-helpful-and-expand config-alist)
 (let* (
        ...
        (midi-laml-emacs-support (defaulted-get 'midi-laml-emacs-support config-alist #f))
        (misc-tools-support (defaulted-get 'misc-tools-support config-alist #f))
    ...
    (pair-up
      (list 'laml-dir 'scheme-system 'laml-platform 'operating-system 'scheme-exec 'command-scheme-exec 'emacs-init-file
            ...
            'emacs-keybindings 'photoshow-comment-glyph 'chords-comment-glyph 'midi-comment-glyph 'laml-misc-tools-glyph 'schemedoc-comment-glyph)
      (list (if (slash-terminated? laml-dir) laml-dir (string-append laml-dir "/"))
            ...
            (if midi-laml-emacs-support "" ";")
            (if misc-tools-support "" ";")
