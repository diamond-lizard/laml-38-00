...
;;;; This is the XML-in-LAML mirror of XHTML1.1 which is derived from flattened the XHTML 1.1 DTD.
;;;; Document validation is integrated in the XHTML1.1 mirror functions.<p>
;;;;
;;;; The <a href="../../lib/xml-in-laml/mirrors/man/xhtml11-mirror.html">XHTML 1.0 mirror functions</a>
...
;;;; (time, color, file-read, and of course the XHTML1.1 mirror library mentioned above).
...
;;;;
;;;; Usage: <kbd>(laml-style "simple-xhtml1.1-validating")</kbd><p>
;;;; There are no external definitions in this library.
;;;; .title Manual of the LAML style for the XHTML1.1
