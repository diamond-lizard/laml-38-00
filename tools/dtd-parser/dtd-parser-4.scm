...
;;; </ol>
;;; Use of TABs in the DTD source file may cause troubles in terms of lexical misinterpretations. 
;;; Therefore it is recommended to convert TABs to spaces before parsing the DTD.<p>
